...
public class MemberServiceImpl implements MemberService {
    ...
    public void sendRejectionEmail(String recipientEmail, String firstName) {
        ...
        try {
            ...
            message.setSubject("Kimwanyi SACCO Memberhip Approval");
            message.setText("Dear " + firstName + ",\n\n" +
                    "We regret to inform you that your Memberhip application to Kimwanyi SACCO has been declined!\n\n Kimwanyi SACCO Team");
    ...
    public Member checkUserCredentials(String userName, String password) {
        Member memberByCredentials = memberDAO.getMemberByCredentials(userName);
    ...
    public boolean changePassword(String old, String newPass, String userName) {
        boolean passwordChangeSuccess = false;
        Member passwordCheck = memberDAO.getMemberByCredentials(userName);
